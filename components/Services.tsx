...
const ServiceCard: React.FC<ServiceCardProps> = ({ service, isVisible, index }) => (
    <div 
        className={`group bg-brand-dark/50 border border-brand-border p-8 rounded-lg transition-all duration-300 hover:border-brand-accent hover:-translate-y-2 backdrop-blur-lg ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}
